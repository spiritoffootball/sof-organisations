...
<div class="submitbox">
	<div id="minor-publishing">
		<div id="misc-publishing-actions">
			<div class="misc-pub-section">
				...
				$misc_pub_section = esc_html__( 'Save your settings here.', 'sof-organisations' );
	...
	<div id="major-publishing-actions">
		<div id="publishing-action">
			<?php submit_button( esc_html__( 'Update', 'sof-organisations' ), 'primary', $this->form_submit_id, false ); ?>
